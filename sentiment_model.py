...
from data_batcher import YelpDataFromFile
...
class SentimentVanillaNeuralNetworkModel(Model):
    def __init__(self,FLAGS,word2id,char2id,word_embed_matrix,char_embed_matrix):
        self.FLAGS=FLAGS
        self.dataObject=YelpDataFromFile(word2id,char2id,word_embed_matrix,char_embed_matrix,self.FLAGS.review_path,self.FLAGS.rating_path,self.FLAGS.batch_size,self.FLAGS.review_length,self.FLAGS.word_length,self.FLAGS.discard_long,self.FLAGS.test_size)
